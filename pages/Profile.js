...
import ProfilePubKeys from '../components/ProfilePubKeys';
...
export default function Profile(props) {
  ...
  useEffect(() => {
    ...
    setCollections([{get_image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR08vz0MsFRneW3Gvxp0-7cV6H7QEOQ25ggclc-rtY&s",
                    ...
                    setCreations([{get_image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR08vz0MsFRneW3Gvxp0-7cV6H7QEOQ25ggclc-rtY&s",
  ...
  return (
    <div>
        ...
        <Container>    
          <ProfilePubKeys beacon_pkh={beacon_pkh} solidity_pkh={solidity_pkh} aleph0_pkh={aleph0_pkh} account={account} account_typ={account_typ} />
