...
export let get_api_url = "https://nftm-postgrest-s5knoljafq-ew.a.run.app";
...
let dbg = (str) => {console.log(str); return str;};
export const ipfs_to_https = (ipfs_url) => `https://gateway.moralisipfs.com/ipfs/${dbg(ipfs_url).replace("ipfs://", "")}`;
