...
export default function CollectionCreationPrew(props: {collection: Collection, on_iframe_metadata_loaded: (token_metadata: ERC1155TokenMetadata) => void}) {
    return (
        <div style={{justifyContent: "center"}}>
            ...
            <MyCard display_iframe={true} display_randomize={true} collection_or_nft={props.collection} type={"no buttons"} href={'#'} on_iframe_metadata_loaded={props.on_iframe_metadata_loaded}/>
        </div>
    )
}